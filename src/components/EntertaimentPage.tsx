...
export default function EntertainmentPage() {
  ...
  const events: Event[] = [
    { id: "1", title: "Байгууллагын эвент", imageUrl: "event1.png" },
    { id: "2", title: "Хувь хүний эвент", imageUrl: "event2.png" },
    { id: "3", title: "Хүүхдийн эвент", imageUrl: "event2.png" },
    { id: "4", title: "Анги, хамт олны эвент", imageUrl: "event2.png" },
  ];
  return (
